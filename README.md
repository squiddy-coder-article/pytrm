...
```bash
sudo curl -sL https://gist.githubusercontent.com/squiddy-coder-article/f7582f5e340817312ceba958f878ba98/raw/pytrm.py -o /usr/local/bin/pytrm && sudo chmod +x /usr/local/bin/pytrm
```
